...
public class ShinseiOreDict {
    ...
    public static void blocks(){
        ...
        OreDictionary.registerOre("oreBarium", ShinseiBlocks.bariteOre);
        ...
        OreDictionary.registerOre("blockScarletEmerald", ShinseiBlocks.scarletEmeraldBlock);
    ...
    public static void items(){
        ...
        OreDictionary.registerOre("dustMercury", ShinseiItems.cinnabarPowder);
        ...
        OreDictionary.registerOre("dustGold", ShinseiItems.goldPowder);
        ...
        OreDictionary.registerOre("dustDiamond", ShinseiItems.diamondPowder);
        OreDictionary.registerOre("dustEmerald", ShinseiItems.emeraldPowder);
        ...
        OreDictionary.registerOre("dustCalciumChloride", ShinseiItems.calciumChloridePowder);
        OreDictionary.registerOre("dustActivatedCarbon", ShinseiItems.carbonActivated);
