...
public class BlockGraniteTile extends PlateShinsei {
    ...
    public BlockGraniteTile(){
        super(Material.rock);
        this.setBlockName(Names.Materials.GRANITE + Names.Forms.TILE);
    ...
    public void registerBlockIcons(IIconRegister iconRegister){
        ...
        for(int i = 0; i < subBlocks.length; i++){
            texture[i] = iconRegister.registerIcon(Reference.RESOURCE_PREFIX + Names.Materials.GRANITE + subBlocks[i]);
        }
    }
